...
const OneWayFlightDetails = ({ flightData, status, allData }) => {
  ...
  return (
    <Box>
      {flightData?.segment?.map((data, index, arr) => (
        <Box key={index}>
          <Grid
            container
            sx={{
          ...
          >
            ...
            <Grid item xs={12} md={3}>
              ...
              >
                ...
                {/* //todo: Text Part */}
                <Box width="90%">
                  <Tooltip followCursor title={data?.marketingCareerName}>
                    <Typography
                      sx={{
                  ...
                  <Tooltip
                    followCursor
                    title={`${data.marketingCareer}-${data.marketingFlight}`}
                  >
                    <Typography
                      sx={{
              ...
              <Box>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {moment(new Date(data?.departureTime)).format("hh:mma")}
                    </span>
                  </Typography>
                </Tooltip>

                <Tooltip followCursor title={data?.departureAirport}>
                  <Typography
                    noWrap
                    sx={{
                ...
                >
                  {moment(new Date(data?.departureTime)).format(
                    "ddd DD MMM YY "
                  )}
                </Typography>
              ...
              <Box>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {moment(data?.arrivalTime.split(",")[0]).format("hh:mma")}
                    </span>
                  </Typography>
                </Tooltip>
                ...
                <Tooltip
                  followCursor
                  title={data?.arrivalAirport.split(",")[0]}
                >
                  <Typography
                    noWrap
                    sx={{
          ...
          >
            ...
            >
              Layover Time{" "}
              {transitCalculation(
                flightData?.segment[index + 1]?.departureTime,
                flightData?.segment[index - 1 + 1]?.arrivalTime
              )}
            </Typography>
          </Box>
        </Box>
